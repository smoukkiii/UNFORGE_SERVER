...
public data class ReforgeCost(public val currencyObj: Int, public val currencyName: String = "Forge Token", public val amount: Int) {
...
public object ReforgeOperationRegistry {
    ...
    public fun cost(operation: ReforgeOperation, base: Int = 100): ReforgeCost =
        ReforgeCost(currencyObj = 13215, currencyName = "Forge Token", amount = when (operation) {
